...
public class Menu {
    ...
    public void update(GameData gameData) {
        ...
        if (shadow && menuPitch != 0.75f){
            Candys3Deluxe.soundManager.setPitch("menu", 0.75f);
            menuPitch = 0.75f;
        } else if (!shadow && menuPitch != 1) {
            Candys3Deluxe.soundManager.setPitch("menu", 1);
            menuPitch = 1;
        }
        ...
        if (optionButton.isSelected()) optionWindowAlpha = Time.increaseTimeValue(optionWindowAlpha, 1, 4);
