    ...
    public void update(Player player){
        switch (roomState){
            case 0:
                ...
                break;
            case 1:
                if (roomUpdate(player) || !attack.isMoved()) return;
                if (side == 0) {
...
//                    if (random.nextInt(5) == 2) attack.setSkip();
            ...
            case 2:
                ...
                if (!bed.update(player)) return;
                transitionRoomState((byte) 3);
                Candys3Deluxe.soundManager.play("peek");
                break;
            case 3:
                if (peek.update()) transitionRoomState((byte) 4);
                break;
        }
    }
    ...
    private boolean roomUpdate(Player player){
