...
public class Cat extends SpriteObject {
        ...
        switch (state){
            case 0:
                ...
                if (type == 2 && rat != null && rat.getState() == 2 && rat.getBedCooldown() > 28){
                    ...
                    if (player.getSide() == 0) side = (byte) (random.nextInt(2) + 1);
            ...
            case 1:
                ...
                if (roomUpdate(soundHandler, rat, player) || attack.notMoved()){
    ...
    public void transitionState(Rat rat, byte state){
        ...
        if (state == 0){
            ...
            else attack.reset(0.65f, 9, 2, (byte) 2, (byte) 1, (byte) 0, 24);
        } else if (state == 2){
