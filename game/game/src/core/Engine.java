            ...
            gamejoltManager.execute(() -> {
                ...
                if (!data.isEmpty()) {
                    if (data.contains("hell")){
                        ...
                        int index = data.indexOf("\"mainCastStar\":");
                        char value = data.charAt(index + 16);
                        System.out.println(value);
                        user.candys3Data.mainCastStar = value - '0';

                        index = data.indexOf("\"shadowCastStar\":");
                        value = data.charAt(index + 18);
                        System.out.println(value);
                        user.candys3Data.mainCastStar = value - '0';
                    }
                } else {
                    ...
                    if (!data.isEmpty()) {
                        user.loadOldData(data);
                        gamejoltManager.dataStore.remove(gamejoltManager, oldUserKey);
                    }
                }
    ...
    public void render(){
        ...
        try {
            ...
            if (gameError == null) {
                ...
                renderHandler.shapeDrawer.filledRectangle(0, 0, appHandler.window.width(), appHandler.window.height());
