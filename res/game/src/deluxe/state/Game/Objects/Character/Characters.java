    ...
    public void render(SpriteBatch batch, Room room){
        if (rat != null){
            ...
            switch (rat.getRoomState()){
                ...
                case 3:
                    if (room.getState() != 0 || room.getFrame() != 0) break;
                    region = ImageManager.getRegion(rat.getPath(), (int) rat.getWidth(), (int) rat.getTwitch().getFrame());
                    break;
                case 4:
        ...
        if (cat != null){
            ...
            switch (cat.getRoomState()){
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (room.getState() == 0 && room.getFrame() == 0) region = ImageManager.getRegion(cat.getPath(), (int) cat.getWidth(), (int) cat.getTwitch().getFrame());
                    break;
                case 4:
        ...
        if (shadowRat != null){
            ...
            switch (shadowRat.getRoomState()){
                ...
                case 3:
                    if (room.getState() != 0 || room.getFrame() != 0) break;
                    region = ImageManager.getRegion(shadowRat.getPath(), (int) shadowRat.getWidth(), (int) shadowRat.getTwitch().getFrame());
                    break;
                case 4:
...
//                    break;
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (room.getState() == 0 && room.getFrame() == 0) region = ImageManager.getRegion(shadowCat.getPath(), (int) shadowCat.getWidth(), (int) shadowCat.getTwitch().getFrame());
                    break;
                case 4:
                    if (room.getState() != 0 || room.getFrame() != 0 || shadowCat.getLeaveFrame() == 18) break;
                    if (shadowCat.getSide() == 1 && shadowCat.getLeaveFrame() > 12) break;
